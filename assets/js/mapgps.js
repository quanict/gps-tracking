...
//		}
	...
	showMarkerInfo:function($marker){
		...
		vmap.markerInfo.setContent('<div id="infowindow-content" class="obi obi-w" >'+
...
//			      if (status == google.maps.GeocoderStatus.OK) {
//			        if (results[1]) {
//			        	$('#infowindow-content .bodyContent').append('<div class="obi-l" >'+results[1].formatted_address+'</div>');
//			        }
//			      }
//		    });
//		}
